                ...
                en materia de aprovechamiento responsable del recurso hídrico y la prestación de servicios de agua potable
                 y saneamiento para los ciudadanos y ciudadanas, aplicando un nuevo modelo de gestión integrador, efectivo y revolucionario,
                  ...
                  en todos los usos del agua, mediante la utilización de tecnología de vanguardia, liderado por servidores públicos conscientes,
                   ...
                   Avanzar en cobertura y continuidad del servicio de agua potable y saneamiento a nivel nacional.
                  Gestionar de manera segura el suministro de agua potable a la población.
                  Generar lineamientos, estrategias y planes de desarrollo orientados a la siembra y cosecha del agua para los distintos usos.
                  Aplicar métodos de gestión socialista del agua para generar espacios de formación, investigación e innovación que aporten soluciones, desarrollados con materias primas y tecnologías propias a los nudos críticos del proceso productivo del agua.
                  Mantener la soberanía en los insumos químicos e industriales del sistema de agua.
              </p>
            </div>
            <div class="card-body p-3">
              <div class="chart">
            ...
            <div id="carouselExampleCaptions" class="carousel slide h-100" data-bs-ride="carousel">
              <div class="carousel-inner border-radius-lg h-100">
                <div class="carousel-item h-100 active">
                    <img src="./assets/img/carousel/aguasdecojedes.png" class="d-block w-100" alt="Wild Landscape"/>
                </div>
                <div class="carousel-item h-100">
                     <img src="./assets/img/carousel/aguasdeejido.png" class="d-block w-100" alt="Wild Landscape"/>
                </div>
                <div class="carousel-item h-100">
                    <img src="./assets/img/carousel/aguasdemonagas.png" class="d-block w-100" alt="Wild Landscape"/>
