...
<body>
    <img style="position: absolute; width: ; height: 50px; height: 50px; float: right; top: 12px " src="<?php echo $image_logo ?>" />
    ...
    ?>
        ...
        ?>
            ...
            <img style="position: absolute; width: 50px; height: 50px; float: right;" src="<?php echo $image_logo ?>" />
        ...
        text-align: right; padding-right: 10px;"><?php echo $minimo ?> msnm</p>
            ...
            <div>
                ...
                <img style="position: absolute; width: 50px; height: 50px; float: right; top: 20px;" src="<?php echo $image_logo ?>" />
