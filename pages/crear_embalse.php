...
<style>
  #modal-show {
    ...
    overflow-y: auto;
    /* Permite el desbordamiento horizontal y agrega una barra de desplazamiento si es necesario */
  }
  ...
  #modal-show table {
    /* width: 100%; */
    /* Hace que las tablas ocupen el 100% del ancho del contenedor */
  }
</style>
          ...
          <div class="p-5 m-5">
            ...
            <div class="row">
              <div style="display:flex; flex-direction:column;" class="col-md-3 col-sm-12 justify-content-between">
                ...
                <a onclick="$('#show-batimetria').modal('show');" class="btn btn-link text-dark text-sm"><i class="fas fa-file-pdf text-lg me-1"></i> Ver</a>
                <!-- </div> -->
                <div class="form-group">
              ...
              <div class="col-md-3 col-sm-12">
                <div class=" form-group">
                  ...
                  <input type="number" class="form-control" id="cota_min" name="cota_min" placeholder="Ingrese los afluentes principales">
                </div>
                <div class=" form-group">
              ...
              <div class="col-md-3 col-sm-12">
                <div class=" form-group">
                  ...
                  <input type="number" class="form-control" id="cota_nor" name="cota_nor" placeholder="Ingrese los afluentes principales">
                </div>
                <div class=" form-group">
              ...
              <div class="col-md-3 col-sm-12">
                <div class=" form-group">
                  ...
                  <input type="number" class="form-control" id="cota_max" name="cota_max" placeholder="Ingrese los afluentes principales">
                </div>
                <div class=" form-group">
...
<script>
  ...
  function construirTabla(embalse, data) {
    var tabla = '<table class="table align-items-center mb-0" border="1">';
