            ...
            <div class="p-5-lg m-5">
              ...
              <div class="row">
                ...
                <div class="col-md-3 col-sm-12">
                  ...
                  <div class=" form-group">
                    ...
                    <input type="text" class="form-control Vnumero numero" id="vol_min" name="vol_min" placeholder="Ingrese el volumen mínimo">
                  </div>
                  <div class=" form-group">
                    <label for="sup_min">Superficie mínima (ha)<span style="font-size: 11px; color:dimgray"> (EJ: 1.234,56)</span></label>
                    <input type="text" class="form-control Vnumero numero" id="sup_min" name="sup_min" placeholder="Ingrese la superficie mínima">
                  </div>
                </div>
                <div class="col-md-3 col-sm-12">
                  <div class=" form-group">
                    <label for="cota_nor">Cota normal (m s.m.n.)<span style="font-size: 11px; color:dimgray"> (EJ: 1.234,56)</span></label>
                    <input type="text" class="form-control Vnumero numero" id="cota_nor" name="cota_nor" placeholder="Ingrese la cota normal">
                  </div>
                  <div class=" form-group">
                    <label for="vol_nor">Volumen normal (Hm³)<span style="font-size: 11px; color:dimgray"> (EJ: 1.234,56)</span></label>
                    <input type="text" class="form-control Vnumero numero" id="vol_nor" name="vol_nor" placeholder="Ingrese el volumen normal">
                  </div>
                  <div class=" form-group">
                    <label for="sup_nor">Superficie normal (ha)<span style="font-size: 11px; color:dimgray"> (EJ: 1.234,56)</span></label>
                    <input type="text" class="form-control Vnumero numero" id="sup_nor" name="sup_nor" placeholder="Ingrese la superficie normal">
                  </div>
                </div>
                <div class="col-md-3 col-sm-12">
                  <div class=" form-group">
                    <label for="cota_max">Cota máxima (m s.m.n.)<span style="font-size: 11px; color:dimgray"> (EJ: 1.234,56)</span></label>
                    <input type="text" class="form-control Vnumero numero" id="cota_max" name="cota_max" placeholder="Ingrese la cota máxima">
                  </div>
                  <div class=" form-group">
                    <label for="vol_max">Volumen máximo (Hm³)<span style="font-size: 11px; color:dimgray"> (EJ: 1.234,56)</span></label>
                    <input type="text" class="form-control Vnumero numero" id="vol_max" name="vol_max" placeholder="Ingrese el volumen máximo">
                  </div>
                  <div class=" form-group">
                    <label for="sup_max">Superficie máxima (ha)<span style="font-size: 11px; color:dimgray"> (EJ: 1.234,56)</span></label>
                    <input type="text" class="form-control Vnumero numero" id="sup_max" name="sup_max" placeholder="Ingrese la superficie máxima">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 form-group">
                  ...
                  <input type="text" class="form-control numero" id="escurrimiento" name="escurrimiento" placeholder="Ingrese el escurrimiento medio">
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 form-group">
                  ...
                  <input type="text" class="form-control numero" id="inicio_construccion" name="inicio_construccion" placeholder="Ingrese el año de inicio de construcción">
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 form-group">
                  <label for="duracion_construccion">Duración de construcción (años)</label>
                  <input type="text" class="form-control numero" id="duracion_construccion" name="duracion_construccion" placeholder="Ingrese la duracion de construcción en años">
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 form-group">
                  <label for="inicio_operacion">Inicio de operación (año)</label>
                  <input type="text" class="form-control numero" id="inicio_operacion" name="inicio_operacion" placeholder="Ingrese el año de inicio de operación">
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 form-group">
              ...
              <div class="row">
                <div class="col-xl-3 col-lg-6 form-group">
                  ...
                  <input type="text" class="form-control numero" id="numero_presas" name="numero_presas" placeholder="Ingrese el número de presas">
                </div>
                <div class="col-xl-3 col-lg-6 form-group">
                ...
                <div class="col-xl-3 col-lg-6 form-group">
                  ...
                  <input type="text" class="form-control numero" id="altura" name="altura" placeholder="Ingrese la altura en metros">
                </div>
                <div class="col-xl-3 col-lg-6 form-group">
                ...
                <div class="col-xl-3 col-lg-6 form-group">
                  ...
                  <input type="text" class="form-control numero" id="longitud_cresta" name="longitud_cresta" placeholder="Ingrese la longitud de la cresta en metros">
                </div>
                <div class="col-xl-3 col-lg-6 form-group">
                  <label for="cota_cresta">Cota de la cresta (m s.m.n.)</label>
                  <input type="text" class="form-control numero" id="cota_cresta" name="cota_cresta" placeholder="Ingrese la cota de la cresta en metros">
                </div>
                <div class="col-xl-3 col-lg-6 form-group">
                  <label for="ancho_cresta">Ancho de la cresta (m)</label>
                  <input type="text" class="form-control numero" id="ancho_cresta" name="ancho_cresta" placeholder="Ingrese el ancho de la cresta en metros">
                </div>
                <div class="col-xl-3 col-lg-6 form-group">
                  <label for="volumen_terraplen">Volumen del terraplen (m³)</label>
                  <input type="text" class="form-control numero" id="volumen_terraplen" name="volumen_terraplen" placeholder="Ingrese el volumen del terraplen">
                </div>
                <div class="col-xl-3 col-lg-6 form-group">
                  <label for="ancho_base">Ancho máximo de base (m)</label>
                  <input type="text" class="form-control numero" id="ancho_base" name="ancho_base" placeholder="Ingrese el ancho máximo de base en metros">
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 form-group">
                  ...
                  <input type="text" class="form-control numero" id="numero_compuertas_aliviadero" name="numero_compuertas_aliviadero" placeholder="Ingrese el numero de compuertas del aliviadero">
                </div>
                <div class="col-xl-3 col-lg-6 form-group">
                  <label for="carga_aliviadero">Carga sobre el vertedero (m)</label>
                  <input type="text" class="form-control numero" id="carga_aliviadero" name="carga_aliviadero" placeholder="Ingrese la carga sobre el vertedero">
                </div>
                <div class="col-xl-3 col-lg-6 form-group">
                  <label for="descarga_aliviadero">Descarga máxima (m³/s)</label>
                  <input type="text" class="form-control numero" id="descarga_aliviadero" name="descarga_aliviadero" placeholder="Ingrese la descarga máxima">
                </div>
                <div class="col-xl-3 col-lg-6 form-group">
                  <label for="longitud_aliviadero">Longitud (m)</label>
                  <input type="text" class="form-control numero" id="longitud_aliviadero" name="longitud_aliviadero" placeholder="Ingrese la longitud">
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 form-group">
                  ...
                  <input type="text" class="form-control numero" id="numero_compuertas_toma" name="numero_compuertas_toma" placeholder="Ingrese el número de compuertas de la obra de toma">
                </div>
                <div class="col-xl-3 col-lg-6 form-group">
                ...
                <div class="col-xl-3 col-lg-6 form-group">
                  ...
                  <input type="text" class="form-control numero" id="gasto_toma" name="gasto_toma" placeholder="Ingrese el gasto máximo de la obra de toma">
                </div>
                <div class="col-xl-3 col-lg-6 form-group">
              ...
              <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 form-group">
                  ...
                  <input type="text" class="form-control numero" id="poblacion" name="poblacion" placeholder="Ingrese la población beneficiada en habitantes">
                </div>
                <div class="col-xl-3 col-lg-6 form-group">
                  <label for="area_riego">Área de riego beneficiada (ha)</label>
                  <input type="text" class="form-control numero" id="area_riego" name="area_riego" placeholder="Ingrese el area de riego beneficiada">
                </div>
                <div class="col-xl-3 col-lg-6 form-group">
                  <label for="area_riego">Área protegida (ha)</label>
                  <input type="text" class="form-control numero" id="area_protegida" name="area_protegida" placeholder="Ingrese el area pretegida">
                </div>
                <div class="col-xl-3 col-lg-6 form-group">
                  <label for="area_riego">Población protegida (hab.)</label>
                  <input type="text" class="form-control numero" id="poblacion_prote" name="poblacion_prote" placeholder="Ingrese la población protegida">
                </div>
                <div class="col-xl-3 col-lg-6 form-group">
                  <label for="area_riego">Producción hidroeléctrica (MW)</label>
                  <input type="text" class="form-control numero" id="produccion_hidro" name="produccion_hidro" placeholder="Ingrese la producción hifroelectrica">
                </div>
                <?php
                $queryEstados = mysqli_query($conn, "SELECT * FROM estados;");
                ?>
...
<script>
  ...
  const keyCodesArrows = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"];
